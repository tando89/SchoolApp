...
public class DepFeedback extends AppCompatActivity {
    //Declare variables
    Button bntfunc;
    EditText FirstName, LastName, StudentID, StudentEmail, Messages;
    //link to server
    String server_url =" https://schoolserver-tand089.c9users.io/DepFeedback.php";

    AlertDialog.Builder builder;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dep_feedback);
        //cast the variables
        ...
        builder = new AlertDialog.Builder(DepFeedback.this);
        ...
        bntfunc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (firstName.equals("") || lastName.equals("") || studentID.equals("")
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.POST, server_url,
                            ...
                            new Response.ErrorListener() {
                                ...
                                public void onErrorResponse(VolleyError error) {
                                    Toast.makeText(DepFeedback.this, "Error!!!", Toast.LENGTH_SHORT).show();
                    ...
                    MySingleton.getInstance(DepFeedback.this).addTorequestqueue(stringRequest);
                }
            }
        });
    }
