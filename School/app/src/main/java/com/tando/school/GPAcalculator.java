    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bntInsert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Convert the letters into Doubles. For example A = 4.00
                ...
                //Display the Toast to let users know what they have inserted
                ...
                //add gradepoints into gradepoints array
                if (gradepoints >= 0) {
                    gradePoints.add(gradepoints);
                } else {
                    Toast.makeText(getApplicationContext(), "Error!!!", Toast.LENGTH_LONG).show();
                }
                //Clear the spinner after pick strings from them
                spinner1.setSelection(0);
                spinner2.setSelection(0);
            }
        });
        //Count GPA button function
        ...
        bntClear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                spinner1.setSelection(0);
                spinner2.setSelection(0);
                resultTotalUnits.setText("Total units: clear");
                resultTotalGrades.setText("Total grade points: clear");
                resultGPA.setText("Your GPA: clear");
                gradePoints.clear();
                unitsAdd.clear();
                gradeAdd.clear();
                gradePoints.clear();
